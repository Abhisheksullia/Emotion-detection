...
var UserSchema = new mongoose_1.default.Schema({
    ...
    type: {
        type: String,
        default: userType_1.default.Student,
        enum: enumArray_1.default(userType_1.default),
    },
    password: {
        type: String,
        required: true,
...
UserSchema.methods.comparePassword = function (candidatePassword) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            user = this;
            return [2 /*return*/, bcryptjs_1.default.compare(candidatePassword, user.password)];
        });
    });
};
