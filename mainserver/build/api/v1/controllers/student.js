...
exports.meetingDetail = exports.meetingLogHandler = exports.joinMeetingHandler = exports.dashboardHandler = exports.getStatusHandler = exports.logoutStudentHandler = exports.loginStudentHandler = exports.createStudentHandler = void 0;
...
var meetingLog_service_1 = require("../services/meetingLog.service");
var status_1 = __importDefault(require("../enums/status"));
var maxkey_1 = __importDefault(require("../helpers/maxkey"));
var detectEmotion_1 = require("../helpers/detectEmotion");
function createStudentHandler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var username, admin, user, token, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    admin = _a.sent();
                    if (admin) {
                        throw new customError_1.default("Bad Request", 404, "Student already exist");
                    }
                    return [4 /*yield*/, user_service_1.createUser(__assign(__assign({}, req.body), { type: userType_1.default.Student }))];
                case 2:
                    user = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, user_service_1.validatePassword(__assign(__assign({}, req.body), { type: userType_1.default.Student }))];
                case 1:
                    admin = _a.sent();
                    if (!admin) {
...
function logoutStudentHandler(req, res) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
...
exports.logoutStudentHandler = logoutStudentHandler;
...
function dashboardHandler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var user, meetings, todaysMeetings, report_1, allMeetings, reportAll_1, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
...
function joinMeetingHandler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    user = req.user;
                    return [4 /*yield*/, meeting_service_1.findAndUpdateMeeting({ meetingLink: req.body.meetingId, status: status_1.default.Pending }, { $addToSet: { users: user._id } }, {})];
                case 1:
                    meetings = _a.sent();
                    if (!meetings) {
...
exports.joinMeetingHandler = joinMeetingHandler;
function meetingLogHandler(req, res) {
    var _a, _b, _c, _d, _e;
    return __awaiter(this, void 0, void 0, function () {
        var user, expresion, drowsy, meeting, random, log, err_5;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    drowsy = ["awake", "drowsy"];
                    return [4 /*yield*/, meeting_service_1.findMeeting({
                ...
                case 1:
                    ...
                    if (!meeting || !req.body.image) {
                        throw new customError_1.default("Bad Reuqest", 404, "No such meeting found ");
                    }
                    return [4 /*yield*/, detectEmotion_1.detectEmotionAndDrowsiness(req)];
                case 2:
                    random = _f.sent();
                    if (!random) {
                        throw new customError_1.default("Bad Request", 404, "Some error occured");
                    }
                    ...
                    console.log("expr", (_a = expresion === null || expresion === void 0 ? void 0 : expresion[random === null || random === void 0 ? void 0 : random.emotionIndex]) !== null && _a !== void 0 ? _a : "sad");
                    return [4 /*yield*/, meetingLog_service_1.createMeetingLog({
                            meetingId: meeting._id,
                            userId: user._id,
                            emotion: (_c = expresion === null || expresion === void 0 ? void 0 : expresion[(_b = random === null || random === void 0 ? void 0 : random.emotionIndex) !== null && _b !== void 0 ? _b : 0]) !== null && _c !== void 0 ? _c : "sad",
                            drowsiness: (_e = drowsy === null || drowsy === void 0 ? void 0 : drowsy[(_d = random === null || random === void 0 ? void 0 : random.drowsinessIndex) !== null && _d !== void 0 ? _d : 0]) !== null && _e !== void 0 ? _e : "awake",
                        })];
                case 3:
                    log = _f.sent();
...
exports.meetingLogHandler = meetingLogHandler;
function meetingDetail(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var user, meetings, err_6;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
